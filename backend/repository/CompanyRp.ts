...
class CompanyRepository {
    //Crear Compañia
    async createCompany(data:ICompany, transaction?:Transaction): Promise<CompanyPg>{
    ...
    //Actualizar Compañia
    async updateCompany(id:number, data:Partial<CompanyPg>): Promise<CompanyPg|null>{
